...
const ROSTER := [
	...
	{"id": "bat",      "name": "Cave Bat",      "hp": 15, "atk": 6,  "def": 1, "spd": 8,  "tier": 0, "boss": false, "elite": false, "starter": true,  "tint": Color(0.59, 0.43, 0.78), "moves": ["strike", "drain"]},
	# --- tier 1: early wild ---
	...
	{"id": "skeleton", "name": "Skeleton",      "hp": 28, "atk": 8,  "def": 4, "spd": 4,  "tier": 1, "boss": false, "elite": false, "starter": false, "tint": Color(0.86, 0.86, 0.82), "moves": ["strike", "heavy", "guard"]},
	# --- tier 2: mid wild ---
	...
	{"id": "spider",   "name": "Giant Spider",  "hp": 33, "atk": 9,  "def": 3, "spd": 9,  "tier": 2, "boss": false, "elite": false, "starter": false, "tint": Color(0.30, 0.30, 0.42), "moves": ["strike", "drain", "focus"]},
	# --- tier 3: late wild ---
	{"id": "golem",    "name": "Stone Golem",   "hp": 58, "atk": 12, "def": 8, "spd": 2,  "tier": 3, "boss": false, "elite": false, "starter": false, "tint": Color(0.55, 0.55, 0.60), "moves": ["slam", "guard"]},
	{"id": "wraith",   "name": "Wraith",        "hp": 40, "atk": 13, "def": 5, "spd": 8,  "tier": 3, "boss": false, "elite": false, "starter": false, "tint": Color(0.50, 0.50, 0.72), "moves": ["strike", "drain", "focus"]},
	# --- elites: tougher, better reward (recruit + full heal) ---
	{"id": "gremlin_knob", "name": "Gremlin Knob", "hp": 53, "atk": 14, "def": 6, "spd": 10, "tier": 3, "boss": false, "elite": true,  "starter": false, "tint": Color(0.80, 0.40, 0.50), "moves": ["strike", "heavy", "drain", "focus"]},
	{"id": "griffin",  "name": "The Griffin",   "hp": 70, "atk": 15, "def": 7, "spd": 9,  "tier": 3, "boss": false, "elite": true,  "starter": false, "tint": Color(0.88, 0.71, 0.27), "moves": ["strike", "heavy", "slam", "guard"]},
	# --- final boss ---
	{"id": "hydra",    "name": "The Hydra",     "hp": 98, "atk": 16, "def": 8, "spd": 6,  "tier": 4, "boss": true,  "elite": false, "starter": false, "tint": Color(0.20, 0.60, 0.55), "moves": ["strike", "heavy", "slam", "drain", "mend"]},
]
